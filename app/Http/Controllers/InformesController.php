...
class InformesController extends Controller {
	...
	public function getInforme( $id)
	{
		switch($id){
			...
			case 2:
				$ly_datos = array();
				$registros = \DB::select('select a.nombres, a.apellidos, d.nombre_aplicacion, c.nombre_modulo from ingenieros a inner join ingenieros_modulos b on a.id = b.ingenieros_id inner join modulos c on c.id = b.modulos_id inner join aplicaciones d on d.id = c.aplicacion_id order by a.nombres asc');
