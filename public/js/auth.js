...
.controller('AddFuncCtrl',['$scope','FuncionalFact', '$route', '$routeParams','$http', function($scope, FuncionalFact,$route, $routeParams, $http){
	...
	$scope.seleccionar = function(id){
		var req = {
			 method: 'POST',
			 url: "http://"+IP_SERVIDOR+"/inventario/index.php/funcionales/"+id+"/"+appId,
			 data: { test: 'test' }
			}
...
.factory('FuncionalFact',function($resource){
	$_token = "{{ csrf_token() }}";
	return $resource("http://"+IP_SERVIDOR+"/inventario/index.php/funcionales/:id/:idApp",{id: "@_id",idApp: "@_idApp"},{
